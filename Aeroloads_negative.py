...
# print(AeroLoads(0.5, 248, 1.12, 0.01).plotting())  # Uncomment for Plotting Total Distribution
# desired_dist([Input Span Location])
# print(AeroLoads(1.225, 10, 10, 0.01).desired_dist(10))  # Uncomment for Desired Value
# print(AeroLoads(0.333, 248, 1.12, 0.01).find_total()[0])  # Uncomment for Functions and Total Values